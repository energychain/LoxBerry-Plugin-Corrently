...
<div class="lb_flex-container country" style="display:none;">
	...
	<div	class="lb_flex-item-spacer"></div>
	<div	class="lb_flex-item-help hint">
	Zum Probieren und Einrichten kannst du vorerst auch "Deutschland" auswählen. Die Datenfelder des Plugins sind identisch.
	</div>
	<div	class="lb_flex-item-spacer"></div>
</div>
...
<div class="lb_flex-container">
	...
	<div	class="lb_flex-item-spacer"></div>
	<div	class="lb_flex-item-help hint">
		Die Preise von Corrently sind in cent/kWh exkl. Steuern. Du kannst eine Formel angeben, um den Preis anzupassen, z.B. um die Netzgebühren zu addieren, und/oder die Preise inkl. Mwst. anzugeben.<br>
